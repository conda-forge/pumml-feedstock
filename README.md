About pumml-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pumml-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14299&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pumml-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pumml` can be installed with `conda`:
...
It is possible to list all of the versions of `pumml` available on your platform with `conda`:
...
```
mamba search pumml --channel conda-forge
```
...
mamba repoquery search pumml --channel conda-forge

# List packages depending on `pumml`:
mamba repoquery whoneeds pumml --channel conda-forge

# List dependencies of `pumml`:
mamba repoquery depends pumml --channel conda-forge
```
